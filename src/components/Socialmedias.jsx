    ...
    return (
        <div>
            <ul className='lg:space-x-12 justify-center mt-5 md:space-x-5 space-x-4 hidden md:flex'>
                <a href="" ><li><FontAwesomeIcon className='text-color5 md:text-4xl text-3xl hover:text-violet-600' icon={faInstagram} /></li></a>
                <a href="" ><li><FontAwesomeIcon className='text-color5 md:text-4xl text-3xl hover:text-blue-400' icon={faLinkedin} /></li></a>
                <a href="" ><li><FontAwesomeIcon className='text-color5 md:text-4xl text-3xl hover:text-blue-600' icon={faFacebook} /></li></a>
                <a href="" ><li><FontAwesomeIcon className='text-color5 md:text-4xl text-3xl hover:text-gray-600' icon={faXTwitter} /></li></a>
                <a href="" ><li><FontAwesomeIcon className='text-color5 md:text-4xl text-3xl hover:text-gray-600' icon={faGithub} /></li></a>
                <a href="" ><li><FontAwesomeIcon className='text-color5 md:text-4xl text-3xl hover:text-red-600' icon={faYoutube} /></li></a>
            </ul>
